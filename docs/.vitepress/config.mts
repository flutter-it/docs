          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                collapsed: true,
                items: [
                  { text: 'Primeros Pasos', link: '/es/documentation/command_it/getting_started' },
                  { text: 'Fundamentos de Command', link: '/es/documentation/command_it/command_basics' },
                  { text: 'Tipos de Command', link: '/es/documentation/command_it/command_types' },
                  { text: 'Propiedades del Command', link: '/es/documentation/command_it/command_properties' },
                  { text: 'Command Results', link: '/es/documentation/command_it/command_results' },
                  { text: 'Control de Progreso', link: '/es/documentation/command_it/progress_control' },
                  { text: 'Configuración Global', link: '/es/documentation/command_it/global_configuration' },
                  { text: 'Command Builders', link: '/es/documentation/command_it/command_builders' },
                  { text: 'Manejo de Errores', link: '/es/documentation/command_it/error_handling' },
                  { text: 'Restricciones', link: '/es/documentation/command_it/restrictions' },
                  { text: 'Encadenamiento de Commands', link: '/es/documentation/command_it/command_chaining' },
                  { text: 'Actualizaciones Optimistas', link: '/es/documentation/command_it/optimistic_updates' },
                  { text: 'Testing', link: '/es/documentation/command_it/testing' },
                  { text: 'Sin watch_it', link: '/es/documentation/command_it/without_watch_it' },
                  { text: 'Mejores Prácticas', link: '/es/documentation/command_it/best_practices' },
                  { text: 'Resolución de Problemas', link: '/es/documentation/command_it/troubleshooting' }
                ]
              },
              {
                text: 'listen_it',
        ...
        items: [
          ...
          },
          {
            ...
            items: [
              ...
              { text: 'Progress Control', link: '/documentation/command_it/progress_control' },
              ...
              { text: 'Command Chaining', link: '/documentation/command_it/command_chaining' },
