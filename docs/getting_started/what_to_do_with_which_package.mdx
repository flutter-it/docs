...
# get_it
Will help you with 1. get_it is a service locator that allows you to register objects and access them from anywhere in your application. Additionally it offers functionality to ensure that all your objects are ready to be used when you need them.

# watch_it
Will help you with 2. watch_it is a library that allows you to watch a value and automatically rebuild your Widgets when the value changes. It can access data registered inside get_it.
